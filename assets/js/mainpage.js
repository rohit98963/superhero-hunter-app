...
function getCharacters(){
    const char_url = `http://gateway.marvel.com/v1/public/characters?&ts=1&apikey=6481fd25088074fa916cdf42fec06798&hash=4ab44511d9eae1abf32d8e06f3a4e28d&limit=100`
    getCharApi(char_url)
}
getCharacters()
...
searchbar.onkeyup = function(event){
    ...
    if(userData!=''){
        ...
        var api_url = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${userData}&ts=1&apikey=6481fd25088074fa916cdf42fec06798&hash=4ab44511d9eae1abf32d8e06f3a4e28d`
        getApi(api_url)
    }
